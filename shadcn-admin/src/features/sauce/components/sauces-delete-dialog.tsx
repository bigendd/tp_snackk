...
export function SaucesDeleteDialog({ open, onOpenChange, currentRow }: Props) {
  const [value, setValue] = useState('')

  const handleDelete = () => {
    if (value.trim() !== currentRow.nom) return
    onOpenChange(false)
    showSubmittedData(currentRow, 'La sauce suivant a été supprimé :')
  }
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            Cette action supprimera définitivement la sauce{' '}
          ...
          <Label className='my-2'>
            ...
            <Input
              ...
              placeholder='Saisissez le nom du sauce pour confirmer la suppression.'
            />
          </Label>
